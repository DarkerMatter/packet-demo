...
use esp_radio::esp_now::{BROADCAST_ADDRESS, PeerInfo, EspNowWifiInterface};
...
async fn main(_spawner: Spawner) -> ! {
    ...
    // Keep _controller alive - dropping it deinits WiFi
    ...
    loop {
        let res = select(ticker.next(), async {
            ...
            println!("Received {:?}", r.info.src_address);
